...
- [x] INT128 - 128-bit signed integer (Firebird 4.0+)
...
### Binary Types
- [ ] BINARY(n) - Fixed-length binary data (synonym for CHAR CHARACTER SET OCTETS)
- [ ] VARBINARY(n) - Variable-length binary data (synonym for VARCHAR CHARACTER SET OCTETS)
